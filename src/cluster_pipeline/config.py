...
def get_default_config() -> dict[str, Any]:
    ...
    return {
        ...
        "z_pad": DEFAULT_Z_PAD,
        "default_radius_arcmin": DEFAULT_RADIUS_ARCMIN,
        "xray": {
            "filename": DEFAULT_XRAY_FILENAME,
            "contour_levels": list(DEFAULT_CONTOUR_LEVELS),
        },
        "radio": {
            "filename": DEFAULT_RADIO_FILENAME,
            "fov": DEFAULT_RADIO_FOV_ARCMIN,
            "start_sigma": DEFAULT_RADIO_START_SIGMA,
            "n_levels": DEFAULT_RADIO_N_LEVELS,
            "contour_step": DEFAULT_RADIO_CONTOUR_STEP,
            "smooth_pix": DEFAULT_RADIO_SMOOTH_PIX,
            "color": DEFAULT_RADIO_COLOR,
            "linewidth": DEFAULT_RADIO_LINEWIDTH,
            "mask_compact": DEFAULT_RADIO_MASK_COMPACT,
            "mask_catalog": None,
        },
    }
